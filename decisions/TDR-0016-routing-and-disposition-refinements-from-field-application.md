...
# TDR-0016 — Refine DAC routing and disposition from the first at-scale field application
...
Ship as v1.11.0, additive — every prior record still validates. The normative routing rule is left
intact; the refinements are added as clarifying guidance around it.

*(This judgement was made on 2026-07-20 and drafted for release as v1.6.0. It sat unmerged on a
branch while v1.6.0 through v1.10.0 shipped other work, and lands here as v1.11.0. The date, the
reasoning and the alternatives are as they stood on the 20th; only the release number changed.)*
