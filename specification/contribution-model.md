...
**Architecture ruling:** [TDR-0022](../decisions/TDR-0022-fragment-contribution-interchange-architecture.md)

Records are reconstructed from **fragments**; documents are merely containers, and there is no
document→record assumption anywhere in this standard. The portable skill interchange structures below
exist so that independent skills — and independent agents, possibly from different vendors — can hand
interpretation work to one another predictably. They are the contract between the skills in
[`skills/`](../skills/) and every record package's interpretation path, nothing more.
...
|---|---|
| Consequential decision | TDR — [`records/decision`](../records/decision/) |
| Operational Value Commitment (OVC) | Value Record — [`records/value`](../records/value/) |
...
[`schemas/shared/`](../schemas/shared/) holds one JSON Schema per structure. As with the record schemas, frontmatter and
