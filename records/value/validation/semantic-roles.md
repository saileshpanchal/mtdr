...
`target_object: ovc`. Field definitions live in [`spec-value-record.md`](../specification/vr.md) §4;
...
[`conformance/FIX-003`](../fixtures/FIX-003-two-commitments-not-one.md) is the demonstration: the
...
So `beneficiary` is load-bearing for [`identity-and-grouping`](../../../specification/identity-and-grouping.md),
