...
This skill turns a [`CandidateAssembly`](../../../../specification/candidate-assembly.md) into a conformant markdown
TDR. It is written for humans and usable by AI assistants. Read [`spec.md`](../../specification/tdr.md) for field
definitions and [`records/decision/validation/`](../../validation/) for the roles and admission test.
...
Apply [`validation/admission.md`](../../validation/admission.md). An inadmissible candidate is not
...
[`shared/provenance.md`](../../../../specification/provenance.md) — but it must exist at the moment of proposal.
