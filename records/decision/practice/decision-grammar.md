...
compiles straight into the existing [MTDR fields](../specification/tdr.md). Nothing here changes a field, a template or
...
on and be held to. The benefit belongs in a [Value Record](../../value/specification/vr.md); the consequence
belongs here.
...
two of the four scopes the specification separates ([spec §4.4](../specification/tdr.md)).
