...
`target_object: consequential-decision`. Field definitions live in [`spec.md`](../../spec.md) §4; this
...
- **`status`** — a candidate's status is `proposed`. Nothing in source material sets it, and evidence
  ...
  [`shared/candidacy-and-ratification.md`](../../shared/candidacy-and-ratification.md).
...
[`identify-record-contributions`](../../skills/identify-record-contributions/).
...
[`shared/temporal-semantics.md`](../../shared/temporal-semantics.md).
