# Conformance fixtures — interpretation

**Version:** 1.0.0 · **Licence:** MIT · **Author:** Sailesh Panchal

Known-answer tests for the interpretation skills. Each fixture supplies synthetic source
material and states exactly what a conforming run must produce — and, more importantly, what it
must **not**.

These complement [`agents/conformance.md`](../agents/conformance.md), which probes a deployed
...
| Fixture | Proves |
|---|---|
| [FIX-001](FIX-001-value-commitment-across-six-sources.md) | A commitment assembles across six sources, with gaps reported and a revision recognised as supersession |
...
| [FIX-003](FIX-003-two-commitments-not-one.md) | Two similar commitments in one programme are **not** merged |
| [FIX-004](FIX-004-complete-in-one-source.md) | A source that does carry a complete record is not fragmented artificially |
