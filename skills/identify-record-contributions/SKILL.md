...
Capture spans as [`SourceFragment`](../../shared/source-fragment.md) first — verbatim, located, hashed. Preserve hedges and provisional markers exactly. "circa £10m (TBC)" is not "£10m", and the difference is usually the finding.
...
A set of [`SourceFragment`](../../shared/source-fragment.md) and [`RecordContribution`](../../shared/record-contribution.md) structures, validating against [`shared/schema/`](../../shared/schema/). Plus a short plain summary a stranger could follow — which objects appear to be present, on what evidence, and what is conspicuously absent.
