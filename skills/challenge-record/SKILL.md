...
[`shared/candidacy-and-ratification.md`](../../shared/candidacy-and-ratification.md), then the relevant
...
([`spec-decision-assurance.md`](../../spec-decision-assurance.md)), and it is a different act with its
