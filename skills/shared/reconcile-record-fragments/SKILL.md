...
[`CandidateAssembly`](../../../specification/candidate-assembly.md) structures validating against [`shared/schema/candidate-assembly.schema.json`](../../../schemas/shared/candidate-assembly.schema.json), each with `status: candidate` — the only legal value. Plus a plain summary naming what was grouped, on what basis, what was deliberately kept apart, and what remains open.
...
- **Emitting anything beyond `candidate`.** The skill proposes; the organisation ratifies — see [`shared/candidacy-and-ratification.md`](../../../specification/candidacy-and-ratification.md).
